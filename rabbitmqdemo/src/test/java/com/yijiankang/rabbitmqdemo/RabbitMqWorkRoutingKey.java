...
@SpringBootTest
public class RabbitMqWorkRoutingKey {
    ...
    public void testProducerMq(){
        for (int i=0;i<5;i++){
            ...
            rabbitTemplate.convertAndSend(RabbitMqRouingKey.EXCHANGE_TOPICS_INFO,"sms",message);
            rabbitTemplate.convertAndSend(RabbitMqRouingKey.EXCHANGE_TOPICS_INFO,"email",message);
